...
typedef A_u_long AEGP_FootageSignature;
...
typedef struct AEGP_UtilitySuite6 {
	...
	SPAPI A_Err (*AEGP_CauseIdleRoutinesToBeCalled)();
	...
	SPAPI A_Err (*AEGP_UpdateFontList)(); // Rescan the system font list.  This will return quickly if the font list hasn't changed.
