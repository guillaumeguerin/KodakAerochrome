...
//CC
#define PF_AE131_PLUG_IN_VERSION			13	// auto-set by prep_codeline_for_release.py, adjust comment if manually edit okay
#define PF_AE131_PLUG_IN_SUBVERS			8	// auto-set by prep_codeline_for_release.py, adjust comment if manually edit okay
...
#define PF_AE_PLUG_IN_VERSION				PF_AE131_PLUG_IN_VERSION	// auto-set by prep_codeline_for_release.py, adjust comment if manually edit okay
#define PF_AE_PLUG_IN_SUBVERS				PF_AE131_PLUG_IN_SUBVERS	// auto-set by prep_codeline_for_release.py, adjust comment if manually edit okay
