...
typedef struct SPBlockDebugSuite {
	/** Reports whether block debugging is enabled.
		...
		*/
	SPAPI SPErr (*GetBlockDebugEnabled)( int *enabled );
	/** Turns debugging on or off.
			@param debug 1 to turn debugging on, 0 to turn it off.
		*/
	SPAPI SPErr (*SetBlockDebugEnabled)( int debug );
...
/** Internal */
SPAPI SPErr SPGetBlockDebugEnabled( int *enabled );
/** Internal */
SPAPI SPErr SPSetBlockDebugEnabled( int debug );
/** Internal */
