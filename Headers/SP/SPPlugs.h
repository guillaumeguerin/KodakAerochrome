...
typedef struct SPPluginsSuite {
	...
	/**	Reports whether a plug-in has received and returned from the interface start-up message.
			...
			@param started [out] A buffer in which to return true (non-zero) if the plug-in has been started,
				false (0) otherwise.
		*/
	SPAPI SPErr (*GetPluginStarted)( SPPluginRef plugin, int *started );
	/**	Sets whether a plug-in has received and returned from the interface start-up message.
		...
		*/
	SPAPI SPErr (*SetPluginStarted)( SPPluginRef plugin, int started );
	/**	Reports whether a plug-in is instructed to skip the start-up message.
		...
		*/
	SPAPI SPErr (*GetPluginSkipShutdown)( SPPluginRef plugin, int *skipShutdown );
	...
	*/
	SPAPI SPErr (*SetPluginSkipShutdown)( SPPluginRef plugin, int skipShutdown );
	/**	Reports whether a plug-in has reported an error condition that makes it unavailable.
		...
		*/
	SPAPI SPErr (*GetPluginBroken)( SPPluginRef plugin, int *broken );
	/**	Sets or clears the broken flag that marks a plug-in as unavailable due to an
		...
		*/
	SPAPI SPErr (*SetPluginBroken)( SPPluginRef plugin, int broken );
	...
	/**	Retrieves a specific property from the property list for a plug-in.	If
        ...
        and returns it.
			...
			@see \c #SPPropertiesSuite
		*/
	SPAPI SPErr (*FindPluginProperty)( SPPluginRef plugin, PIType vendorID, PIType propertyKey, int propertyID, PIProperty **p );
...
/** Internal */
SPAPI SPErr SPGetPluginStarted( SPPluginRef plugin, int *started );
/** Internal */
SPAPI SPErr SPSetPluginStarted( SPPluginRef plugin, int started );
/** Internal */
SPAPI SPErr SPGetPluginSkipShutdown( SPPluginRef plugin, int *skipShutdown );
/** Internal */
SPAPI SPErr SPSetPluginSkipShutdown( SPPluginRef plugin, int skipShutdown );
/** Internal */
SPAPI SPErr SPGetPluginBroken( SPPluginRef plugin, int *broken );
/** Internal */
SPAPI SPErr SPSetPluginBroken( SPPluginRef plugin, int broken );
/** Internal */
