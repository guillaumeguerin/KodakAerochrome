...
typedef struct SPSuitesSuite {
	...
	SPAPI SPErr (*AddSuite)( SPSuiteListRef suiteList, SPPluginRef host, const char *name,
				int apiVersion, int internalVersion, const void *suiteProcs, SPSuiteRef *suite );
	...
	/** Acquires a function suite from a suite list. Loads the suite if necessary,
		...
		*/
	SPAPI SPErr (*AcquireSuite)( SPSuiteListRef suiteList, const char *name, int apiVersion,
				int internalVersion, const void **suiteProcs );
	...
	/** Decrements the reference count of a suite in a suite list and unloads it when the
		reference count reaches 0.
			...
			@param internalVersion The internal suite version number.
		*/
	SPAPI SPErr (*ReleaseSuite)( SPSuiteListRef suiteList, const char *name, int apiVersion,
				int internalVersion );
	...
	/** Retrieves a suite from a suite list.
		...
		*/
	SPAPI SPErr (*FindSuite)( SPSuiteListRef suiteList, const char *name, int apiVersion,
				int internalVersion, SPSuiteRef *suite );
	...
	/** Retrieves the public version number of a suite.
		...
		*/
	SPAPI SPErr (*GetSuiteAPIVersion)( SPSuiteRef suite, int *version );
	/** Retrieves the internal version number of a suite.
		...
		*/
	SPAPI SPErr (*GetSuiteInternalVersion)( SPSuiteRef suite, int *version );
	...
	/** Retrieves the current reference count of a suite.
		...
		*/
	SPAPI SPErr (*GetSuiteAcquireCount)( SPSuiteRef suite, int *count );
...
/** Internal */
SPAPI SPErr SPAcquireSuite( SPSuiteListRef suiteList, const char *name, int apiVersion,
			int internalVersion, const void **suiteProcs );

/** Internal */
SPAPI SPErr SPReleaseSuite( SPSuiteListRef suiteList, const char *name, int apiVersion,
			int internalVersion );

/** Internal */
SPAPI SPErr SPFindSuite( SPSuiteListRef suiteList, const char *name, int apiVersion,
			int internalVersion, SPSuiteRef *suite );
...
/** Internal */
SPAPI SPErr SPGetSuiteAPIVersion( SPSuiteRef suite, int *version );
/** Internal */
SPAPI SPErr SPGetSuiteInternalVersion( SPSuiteRef suite, int *version );
/** Internal */
SPAPI SPErr SPGetSuiteProcs( SPSuiteRef suite, const void **suiteProcs );
/** Internal */
SPAPI SPErr SPGetSuiteAcquireCount( SPSuiteRef suite, int *count );
